...
def get_highest_num(numbers):
    ...
    # highest_num variable is initialized to the first number in the list since that's the start of the loop
    highest_num = numbers[0]

    # The for loop iterates through each number in the list
    for number in numbers:
        # If the number is greater than the highest_num variable, the number becomes the new highest_num
...
def get_lowest_num(numbers):
    ...
    # lowest_num variable is initialized to the first number in the list since that's the start of the loop
    lowest_num = numbers[0]

    # The for loop iterates through each number in the list
    for number in numbers:
        # If the number is less than the lowest_num variable, the number becomes the new lowest_num
